...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a class="breadcrumb-item" href="{{ route('profiles.index') }}" class=""> / Perfis</a></li>
        <li><a class="breadcrumb-item active" href="{{ route('profiles.plans', $profile->id) }}" class="active"> / Planos</a></li>
    </ol>
